...
namespace GestionDesArticles
{
    internal class ConsoleUserInterface
    {
        ...
        public static void ShowArticle(Article Ar)
        {
            ...
            Console.Write("\n Prix : " + Ar.Prix);
            Console.Write("\n Date de fabrication : " + Ar.DateFabrication.ToString());
                        ...
                        case '1':
                            {
                                Console.Clear();
                                Console.WriteLine("\n************ Ajout ************");
                                BusinessLogicLayer.Add(GetArticleFromInterface());
                                break;
                            }
                        ...
                        case '2':
                            {
                                ...
                                BusinessLogicLayer.Delete(Int32.Parse(Console.ReadLine()));
                                break;
                        ...
                        case '3':
                            {
                                ...
                                Ar = BusinessLogicLayer.GetById(Reference);
                                ShowArticle(Ar);
                                Console.WriteLine("\nDonner les nouvelles données de l'Article :");
                                BusinessLogicLayer.Update(Ar, ConsoleUserInterface.GetArticleFromInterface());
                                break;
                            }
                        ...
                        case '4':
                            {
                                Console.Clear();
                                Console.WriteLine("\n************ Consultation ************");
                                List<Article> LesArticles = BusinessLogicLayer.GetAll();
